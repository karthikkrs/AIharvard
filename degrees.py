...
def shortest_path(source, target):
    ...
    while queue:
        ...
        # Iterate over neighbors of the current person
        for movie_id, person_id in neighbors_for_person(current_person):
            # If the neighbor has not been visited yet
            if person_id not in visited:
                queue.append(person_id)
                visited[person_id] = (movie_id, current_person)

    # If the target person was not found
    ...
    while current != source:
        movie_id, previous = visited[current]
